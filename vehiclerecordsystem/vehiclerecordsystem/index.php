                     ...
                     <div class="carousel-inner">
                        <div class="carousel-item active">
                           <div class="banner_taital_main">
                              ...
                              <p class="banner_text">Allows you to record multiple vehicle of either same or different brand</p>
                              <div class="btn_main">
                        ...
                        <div class="carousel-item">
                           <div class="banner_taital_main">
                              <h1 class="banner_taital">Model Based Record <br><span style="color: #fe5b29;">Using DBMS</span></h1>
                              <p class="banner_text">Vehicle record can be used in various fields to track or safe keep important details</p>
                              <div class="btn_main">
                        ...
                        <div class="carousel-item">
                           <div class="banner_taital_main">
                              <h1 class="banner_taital">Vehicle Record <br><span style="color: #fe5b29;">For You</span></h1>
                              <p class="banner_text">Vehicle record tracks the types a brand ,may have mutiple varients or model</p>
                              <div class="btn_main">
...
?>
      ...
      <div class="search_section">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <h1 class="search_taital">Search ! (name,modelnumber....)</h1>
                        ...
                        <div class="select_box_main">
                           ...
                           <div class="row">
                              <div class="col-md-8 select-outline">
                                   <input type="text"  name="searchinputdata" class="form-control" required="true" placeholder="Enter VehicleName,Model Number...">
                              </div>
...
where tblvehicle.VehicleName like '$searchinput' || tblvehicle.ModelNum like '$searchinput' || tblvehicle.RegNum like '$searchinput'";
               ...
               <?php }} else{ ?>
                  <p style="color:red">OOPS !,No record found </p><?php } ?>
            </div>
