                    ...
                    <table class="table table-hover">
                      <thead>
                        <tr>
                                        ...
                                        <th> <span class="f-light f-w-600">Order Date</span></th>
                      ...
                      <?php 
                $i=0;
                                                $st=$admin->ret("select * from `order` inner join `branch` on branch.b_id=order.b_id");
                                        ...
                                        <td>
                                            ...
                                            <div class="product-names">
                                                <div class="light-product-box"><img class="img-fluid"
                                                        src="../controller/<?php echo $row['profile']; ?>" alt="laptop" /></div>
                                                <p><?php echo $row['bname']; ?></p>
                                            </div>
                                        </td>
                                        <td>
                                            <p class="f-light"><?php echo $row['order_date']; ?></p>
                                        </td>
                                        <td>
                                            <p class="f-light"><?php echo $row['order_no']; ?></p>
                                        </td>
                                        <td>
                                            <p class="f-light">₹<?php echo $row['grand_total']; ?></p>
                                        </td>

                                        <td>

                                            <span
                                                class="badge badge-light-secondary" style="color:red;"><?php echo $row['order_status']; ?></span>
                                            <?php 
if($row['order_status']=='pending'){
  ?>
                                            <select class="form-select" id="select" style="width:150px;color:#308e87;"
                                                onchange="update(this.value,<?php echo $row['order_id']; ?>)">
                                                <option value="" selected disabled>Update Order</option>
                              ...
                              if($row['mode']=='cod'){
                                ?>
                                            ...
                                            <?php
}else if($row['order_status']=='ordered'){
  ?>
                                            <select class="form-select" id="select" style="width:150px;color:#308e87;"
                                                onchange="update(this.value,<?php echo $row['order_id']; ?>)">
                                                <option value="" selected disabled>Update Order</option>
  ...
  ?>
                              ...
                              if($row['mode']=='cod'){
                                ?>
                                            ...
                                            <?php
}else if($row['order_status']=='on_the_way' && !isset($_GET['st'])){
  ?>
                                            <select class="form-select" id="select" style="width:150px;color:#308e87;"
                                                onchange="update(this.value,<?php echo $row['order_id']; ?>)">
                                                <option value="" selected disabled>Update Order</option>
  ...
  ?>
                                        ...
                                        <script>
                                        function update(status, oid) {
                                            window.location.href = '../controller/checkout.php?st=' + status +
                                                '&oid=' + oid;
