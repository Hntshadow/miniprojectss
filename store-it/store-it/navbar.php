...
if(isset($_SESSION['b_id'])){
    ...
    $user=$admin->ret("select * from `branch` where `b_id`='$bid'");
    $ruser=$user->fetch(PDO::FETCH_ASSOC);


    $s=$admin->ret("select * from `cart`  where `b_id`='$bid' and `cstatus`='pending'");
    $cart_count=$s->rowCount();
...
<!-- Mirrored from template.hasthemes.com/hmart/hmart/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Apr 2025 05:25:28 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col">
                            <div class="welcome-text">
                                <p>  STORE, PURCHASE, REAPEAT</p>
                            </div>
                        </div>
                        <div class="col d-none d-lg-block">
                            <div class="top-nav">
                                <ul>
                                    <li><a href="tel:0123456789"><i class="fa fa-phone"></i> +918549905209</a></li>
                                    <li><a href="mailto:demo@example.com"><i class="fa fa-envelope-o"></i> store-it@gmail.com</a></li>
                    ...
                    <div class="row justify-content-between align-items-center">
                        <div class="col-lg-3 col">
                            <div class="header-logo">
                                <a href="index.php" style="color:white;font-weight:900;font-size:25px;"><img src="assets/logo.png" style="width:50px;height:50px;margin-right:20px;" alt="Site Logo" />STORE IT</a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col">
                            <div class="header-actions">
                                ...
                                <!-- Single Wedge End -->
                                <a href="cart.php" class="header-action-btn header-action-btn-cart  pr-0">
                                    <i class="pe-7s-shopbag"></i>
                                    <span class="header-action-num"><?php echo $cart_count; ?></span>
                                    <!-- <span class="cart-amount">€30.00</span> -->
                                </a>
                                <a href="cart.php" class="header-action-btn header-action-btn-menu  d-lg-none">
...
<li><a href="controller/login.php?role=branch">Sign Out</a></li>
    <?php
}else{
    ?>
